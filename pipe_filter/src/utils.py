...
from pipe_filter.src.db import con
...
@dataclass
class Task:
    def __init__(self, title, id=-1, description=None, completed=False, list_id=-1, parent_id=None, list_name=None, parent_name=None):
        self.title = title
        self.id = id
        self.description = description
